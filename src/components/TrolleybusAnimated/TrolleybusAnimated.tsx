...
import styles from './TrolleybusAnimated.module.scss'

const TrolleybusAnimated: React.FC = () => {
	return (
		<div className={styles.BusContainer}>
			<div className={styles.Bus}>
				...
				>
					<path fill='currentColor' d='M66.4 3h7.8L57.6 23h-7.8L66.4 3Z' />
					<path
						fill='currentColor'
						fillRule='evenodd'
						...
						clipRule='evenodd'
					/>
					<path fill='currentColor' d='M86.3 3h-7.8L62 23h7.8L86.3 3Z' />
				</svg>
			</div>
